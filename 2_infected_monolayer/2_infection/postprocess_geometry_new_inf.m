...
% Plot area infected vs uninfected paper %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure()
hold on
frame_ini = 90;
create_time = 420:10:1520;

name1 = "25th perc uninf "+ case_name; name4 = "25th perc inf "+ case_name       ;
name2 = "50th perc uninf "+ case_name; name5 = "50th perc inf "+ case_name       ;
name3 = "75th perc uninf "+ case_name; name6 = "75th perc inf "+ case_name       ;
p1    = plot(create_time(1:end), prctile_area_uninf_step(frame_ini:end,1), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p2    = plot(create_time(1:end), prctile_area_uninf_step(frame_ini:end,2),                   'Color', 'blue','LineWidth', 1.5);
p3    = plot(create_time(1:end), prctile_area_uninf_step(frame_ini:end,3), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p4    = plot(create_time(1:end), prctile_area_inf_step  (frame_ini:end,1), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);
p5    = plot(create_time(1:end), prctile_area_inf_step  (frame_ini:end,2),                   'Color', 'red' ,'LineWidth', 1.5);
p6    = plot(create_time(1:end), prctile_area_inf_step  (frame_ini:end,3), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);

xlim([420 1520])
ylim([90 220])
Fontsize   = 20;
tickLocations = 450:250:1500;
xticks(tickLocations);

lgd = legend([p2, p5], {name2, name5});
title ('Area [\mum^2]' ,'FontSize',Fontsize );
ylabel('Area [\mum^2]' ,'FontSize',Fontsize);
xlabel('Steps'         ,'FontSize',Fontsize);
...
hold off
picname    = "area_inf_vs_uninf_comparison_paper_" + case_name + ".png";
saveas(gcf, picname);
...
edges = 100:5:350; % histogram edges (range)
...
% Plot perimeter infected vs uninfected paper %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure()
hold on
frame_ini = 90;
create_time = 420:10:1520;
...
name2 = "50th perc uninf "+ case_name; name5 = "50th perc inf "+ case_name       ;
name3 = "75th perc uninf "+ case_name; name6 = "75th perc inf "+ case_name       ;
p1    = plot(create_time(1:end), prctile_perim_uninf_step(frame_ini:end,1), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p2    = plot(create_time(1:end), prctile_perim_uninf_step(frame_ini:end,2),                   'Color', 'blue','LineWidth', 1.5);
p3    = plot(create_time(1:end), prctile_perim_uninf_step(frame_ini:end,3), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p4    = plot(create_time(1:end), prctile_perim_inf_step  (frame_ini:end,1), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);
p5    = plot(create_time(1:end), prctile_perim_inf_step  (frame_ini:end,2),                   'Color', 'red' ,'LineWidth', 1.5);
p6    = plot(create_time(1:end), prctile_perim_inf_step  (frame_ini:end,3), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);
...
lgd = legend([p2, p5], {name2, name5});
title ('Perimeter [\mum]' ,'FontSize',Fontsize );
ylabel('Perimeter [\mum]' ,'FontSize',Fontsize);
xlabel('Steps'         ,'FontSize',Fontsize);
...
ax.YAxis.FontName = 'Arial';
hold off
picname    = "perim_inf_vs_uninf_comparison_paper_" + case_name + ".png";
saveas(gcf, picname);
...
% Plot cshape infected vs uninfected paper %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure()
hold on
frame_ini = 90;
create_time = 420:10:1520;
...
name2 = "50th perc uninf "+ case_name; name5 = "50th perc inf "+ case_name       ;
name3 = "75th perc uninf "+ case_name; name6 = "75th perc inf "+ case_name       ;
p1    = plot(create_time(1:end), prctile_cell_shape_uninf_step(frame_ini:end,1), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p2    = plot(create_time(1:end), prctile_cell_shape_uninf_step(frame_ini:end,2),                   'Color', 'blue','LineWidth', 1.5);
p3    = plot(create_time(1:end), prctile_cell_shape_uninf_step(frame_ini:end,3), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p4    = plot(create_time(1:end), prctile_cell_shape_inf_step  (frame_ini:end,1), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);
p5    = plot(create_time(1:end), prctile_cell_shape_inf_step  (frame_ini:end,2),                   'Color', 'red' ,'LineWidth', 1.5);
p6    = plot(create_time(1:end), prctile_cell_shape_inf_step  (frame_ini:end,3), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);
...
lgd = legend([p2, p5], {name2, name5});
title ('Cell shape [-]' ,'FontSize',Fontsize );
ylabel('Cell shape [-]' ,'FontSize',Fontsize);
xlabel('Steps'         ,'FontSize',Fontsize);
...
ax.YAxis.FontName = 'Arial';
hold off
picname    = "cshape_inf_vs_uninf_comparison_paper_" + case_name + ".png";
saveas(gcf, picname);
...
% Plot displacement magnitude infected vs uninfected paper %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure()
hold on
frame_ini = 90;
create_time = 420:10:1520;
...
name2 = "50th perc uninf "+ case_name; name5 = "50th perc inf "+ case_name       ;
name3 = "75th perc uninf "+ case_name; name6 = "75th perc inf "+ case_name       ;
p1    = plot(create_time(1:end), prctile_disp_vec_uninf_step(frame_ini:end,1), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p2    = plot(create_time(1:end), prctile_disp_vec_uninf_step(frame_ini:end,2),                   'Color', 'blue','LineWidth', 1.5);
p3    = plot(create_time(1:end), prctile_disp_vec_uninf_step(frame_ini:end,3), 'LineStyle', ':', 'Color', 'blue','LineWidth', 0.8);
p4    = plot(create_time(1:end), prctile_disp_vec_inf_step  (frame_ini:end,1), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);
p5    = plot(create_time(1:end), prctile_disp_vec_inf_step  (frame_ini:end,2),                   'Color', 'red' ,'LineWidth', 1.5);
p6    = plot(create_time(1:end), prctile_disp_vec_inf_step  (frame_ini:end,3), 'LineStyle', ':', 'Color', 'red' ,'LineWidth', 0.8);
...
lgd = legend([p2, p5], {name2, name5});
title ('|Cell displacement| [\mum]' ,'FontSize',Fontsize );
ylabel('|Cell displacement| [\mum]' ,'FontSize',Fontsize);
xlabel('Steps'         ,'FontSize',Fontsize);
...
ax.YAxis.FontName = 'Arial';
hold off
picname    = "disp_magn_inf_vs_uninf_comparison_paper_" + case_name + ".png";
saveas(gcf, picname);
...
prctile_tot_dist_inf_step      = zeros(total_time_steps,3);
prctile_tot_dist_uninf_step    = zeros(total_time_steps,3);
...
for i = 1 : total_time_steps
    ...
    % Infected:
    id_cells_infected                = logical(infection_time(:,i))              ;
    tot_dist_cells_infected          = tot_dis_all_cells(id_cells_infected)      ;
    prctile_tot_dist_inf_step(i,1)   = prctile(tot_dist_cells_infected,25)       ;
    prctile_tot_dist_inf_step(i,2)   = prctile(tot_dist_cells_infected,50)       ;
    prctile_tot_dist_inf_step(i,3)   = prctile(tot_dist_cells_infected,75)       ;
    % Uninfected: remove cells at the boundary
    id_cells_uninfected              = ~infection_time(:,i)                      ;
    id_cells_uninfected              = id_cells_uninfected-id_cells_out          ; % remove cells at the boundary
    id_cells_uninfected              = logical(id_cells_uninfected)              ; 
    tot_dist_cells_uninfected        = tot_dis_all_cells(id_cells_uninfected)    ;
    prctile_tot_dist_uninf_step(i,1) = prctile(tot_dist_cells_uninfected,25)     ;
    prctile_tot_dist_uninf_step(i,2) = prctile(tot_dist_cells_uninfected,50)     ;
    prctile_tot_dist_uninf_step(i,3) = prctile(tot_dist_cells_uninfected,75)     ;
...
% Plot total distance infected vs uninfected
figure()
hold on
name1 = "25th perc uninf "+ case_name; name4 = "25th perc inf "+ case_name       ;
name2 = "50th perc uninf "+ case_name; name5 = "50th perc inf "+ case_name       ;
name3 = "75th perc uninf "+ case_name; name6 = "75th perc inf "+ case_name       ;
p1    = plot(sim_time_min(2:end) ,prctile_tot_dist_uninf_step(2:end,1), 'LineStyle', ':', 'Color', 'blue');
p2    = plot(sim_time_min(2:end) ,prctile_tot_dist_uninf_step(2:end,2),                   'Color', 'blue');
p3    = plot(sim_time_min(2:end) ,prctile_tot_dist_uninf_step(2:end,3), 'LineStyle', ':', 'Color', 'blue');
p4    = plot(sim_time_min(2:end) ,prctile_tot_dist_inf_step  (2:end,1), 'LineStyle', ':', 'Color', 'red' );
p5    = plot(sim_time_min(2:end) ,prctile_tot_dist_inf_step  (2:end,2),                   'Color', 'red' );
p6    = plot(sim_time_min(2:end) ,prctile_tot_dist_inf_step  (2:end,3), 'LineStyle', ':', 'Color', 'red' );
...
xlabel('Simulation time [min]'         );
hold off
picname    = "total_dist_inf_vs_uninf_comparison_" + case_name + ".png";
saveas(gcf, picname);
...
prctile_tot_disp_inf_step      = zeros(total_time_steps,3);
prctile_tot_disp_uninf_step    = zeros(total_time_steps,3);
...
for i = 1 : total_time_steps
    ...
    % Infected:
    id_cells_infected                = logical(infection_time(:,i))              ;
    tot_disp_cells_infected          = tot_disp_all_cells(id_cells_infected)     ;
    prctile_tot_disp_inf_step(i,1)   = prctile(tot_disp_cells_infected,25)       ;
    prctile_tot_disp_inf_step(i,2)   = prctile(tot_disp_cells_infected,50)       ;
    prctile_tot_disp_inf_step(i,3)   = prctile(tot_disp_cells_infected,75)       ;
    % Uninfected: remove cells at the boundary
    id_cells_uninfected              = ~infection_time(:,i)                      ;
    id_cells_uninfected              = id_cells_uninfected-id_cells_out          ; % remove cells at the boundary
    id_cells_uninfected              = logical(id_cells_uninfected)              ; 
    tot_disp_cells_uninfected        = tot_disp_all_cells(id_cells_uninfected)   ;
    prctile_tot_disp_uninf_step(i,1) = prctile(tot_disp_cells_uninfected,25)     ;
    prctile_tot_disp_uninf_step(i,2) = prctile(tot_disp_cells_uninfected,50)     ;
    prctile_tot_disp_uninf_step(i,3) = prctile(tot_disp_cells_uninfected,75)     ;
...
% Plot total displacement infected vs uninfected
figure()
hold on
name1 = "25th perc uninf "+ case_name; name4 = "25th perc inf "+ case_name       ;
name2 = "50th perc uninf "+ case_name; name5 = "50th perc inf "+ case_name       ;
name3 = "75th perc uninf "+ case_name; name6 = "75th perc inf "+ case_name       ;
p1    = plot(sim_time_min(2:end) ,prctile_tot_disp_uninf_step(2:end,1), 'LineStyle', ':', 'Color', 'blue');
p2    = plot(sim_time_min(2:end) ,prctile_tot_disp_uninf_step(2:end,2),                   'Color', 'blue');
p3    = plot(sim_time_min(2:end) ,prctile_tot_disp_uninf_step(2:end,3), 'LineStyle', ':', 'Color', 'blue');
p4    = plot(sim_time_min(2:end) ,prctile_tot_disp_inf_step  (2:end,1), 'LineStyle', ':', 'Color', 'red' );
p5    = plot(sim_time_min(2:end) ,prctile_tot_disp_inf_step  (2:end,2),                   'Color', 'red' );
p6    = plot(sim_time_min(2:end) ,prctile_tot_disp_inf_step  (2:end,3), 'LineStyle', ':', 'Color', 'red' );
...
xlabel('Simulation time [min]'         );
hold off
picname    = "total_disp_inf_vs_uninf_comparison_" + case_name + ".png";
saveas(gcf, picname);
...
prctile_dir_ratio_inf_step      = zeros(total_time_steps,3);
prctile_dir_ratio_uninf_step    = zeros(total_time_steps,3);
...
for i = 1 : total_time_steps
    ...
    % Infected:
    id_cells_infected                = logical(infection_time(:,i))              ;
    dir_ratio_cells_infected         = dir_ratio_all_cells(id_cells_infected)    ;
    prctile_dir_ratio_inf_step(i,1)  = prctile(dir_ratio_cells_infected,25)      ;
    prctile_dir_ratio_inf_step(i,2)  = prctile(dir_ratio_cells_infected,50)      ;
    prctile_dir_ratio_inf_step(i,3)  = prctile(dir_ratio_cells_infected,75)      ;
    % Uninfected: remove cells at the boundary
    id_cells_uninfected               = ~infection_time(:,i)                     ;
    id_cells_uninfected               = id_cells_uninfected-id_cells_out         ; % remove cells at the boundary
    id_cells_uninfected               = logical(id_cells_uninfected)             ; 
    dir_ratio_cells_uninfected        = dir_ratio_all_cells(id_cells_uninfected) ;
    prctile_dir_ratio_uninf_step(i,1) = prctile(dir_ratio_cells_uninfected,25)   ;
    prctile_dir_ratio_uninf_step(i,2) = prctile(dir_ratio_cells_uninfected,50)   ;
    prctile_dir_ratio_uninf_step(i,3) = prctile(dir_ratio_cells_uninfected,75)   ;
...
name2 = "50th perc uninf "+ case_name; name5 = "50th perc inf "+ case_name       ;
name3 = "75th perc uninf "+ case_name; name6 = "75th perc inf "+ case_name       ;
p1    = plot(sim_time_min(2:end) ,prctile_dir_ratio_uninf_step(2:end,1), 'LineStyle', ':', 'Color', 'blue');
p2    = plot(sim_time_min(2:end) ,prctile_dir_ratio_uninf_step(2:end,2),                   'Color', 'blue');
p3    = plot(sim_time_min(2:end) ,prctile_dir_ratio_uninf_step(2:end,3), 'LineStyle', ':', 'Color', 'blue');
p4    = plot(sim_time_min(2:end) ,prctile_dir_ratio_inf_step  (2:end,1), 'LineStyle', ':', 'Color', 'red' );
p5    = plot(sim_time_min(2:end) ,prctile_dir_ratio_inf_step  (2:end,2),                   'Color', 'red' );
p6    = plot(sim_time_min(2:end) ,prctile_dir_ratio_inf_step  (2:end,3), 'LineStyle', ':', 'Color', 'red' );

lgd = legend([p2, p5], {name2, name5});
title ('Cell directionality ratio [-]' );
ylabel('Cell directionality ratio [-]' );
xlabel('Simulation time [min]'         );
hold off
picname    = "dir_ratio_inf_vs_uninf_comparison_" + case_name + ".png";
saveas(gcf, picname);
