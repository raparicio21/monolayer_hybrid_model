function vtkwrite_polygons( filename,dataType,varargin )
...
% This is 10 times faster and it is okay with Paraview format
        ...
        for i = 1:length(varargin{4})
            count = count + size(varargin{5}{i,:},1);
        end

        fprintf(fid, sprintf('\nPOLYGONS %d %d\n',numel(varargin{5}), numel(varargin{5}) + count)); % 
