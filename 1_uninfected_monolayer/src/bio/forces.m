classdef forces
    ...
    methods
        ...
        function cell_int_force = calculateInteraction(~,iterator,neighbours_id,mon_cell_radius,mon_cell_pos,mon_cell_infection)
        ...
        function [centroid_cont_force, vert_forces, cont_vert_coor, cont_vert_forc] = calculateContraction(~,iterator, ...
                   inf_state, step, cell_pos, mon_polygons, mon_regions, mon_vertices, vert_forces, cont_vert_coor, cont_vert_forc ...
                   , random_contraction, average_cell_stress)
        ...
        function monolayer = calculateInfectionCrawling(~,iterator,monolayer,mon_regions)

            crawling_magn     = inputs.forces_infection_magnitude;
