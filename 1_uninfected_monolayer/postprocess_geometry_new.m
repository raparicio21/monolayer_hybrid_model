...
hold on
plot(sim_time_min(25:end) , prctile_disp_vec_magn_step(25:end,1))
plot(sim_time_min(25:end) , prctile_disp_vec_magn_step(25:end,2))
plot(sim_time_min(25:end) , prctile_disp_vec_magn_step(25:end,3))
legend('25th perc','50th perc','75th perc');
title ('Cell displacement [\mum]' );
ylabel('Cell displacement [\mum]' );
xlabel('Simulation time [min]'         ); ylim([0 1.8])
hold off
% nbins = 10;
...
hold on
plot(sim_time_min(25:end) , prctile_velocity_magn_step(25:end,1))
plot(sim_time_min(25:end) , prctile_velocity_magn_step(25:end,2))
plot(sim_time_min(25:end) , prctile_velocity_magn_step(25:end,3))
legend('25th perc','50th perc','75th perc');
title ('Cell nuclei velocity [\mum/min]' );
ylabel('Cell velocity [\mum/min]' ); ylim([0 0.09])
xlabel('Simulation time [min]'         );
hold off
% nbins = 10;
% histogram(displacement_time_magn(:,2),nbins);
